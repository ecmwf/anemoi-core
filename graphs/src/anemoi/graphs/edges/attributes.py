...
class DirectionalHarmonics(EdgeDirection):
    ...
    def __init__(self, name: str, order: int = 3, norm: str | None = None, dtype: str = "float32") -> None:
        self.order = order
...
class BaseEdgeAttributeFromNodeBuilder(BaseBooleanEdgeAttributeBuilder, ABC):
    ...
    def __init__(self, name: str, node_attr_name: str) -> None:
...
class GaussianDistanceWeights(EdgeLength):
    ...
    def __init__(self, name: str, sigma: float = 1.0, norm: str = "l1", **kwargs) -> None:
        self.sigma = sigma
