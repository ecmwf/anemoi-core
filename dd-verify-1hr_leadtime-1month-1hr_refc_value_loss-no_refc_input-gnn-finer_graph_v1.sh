#!/bin/bash
#SBATCH -A fv3-cam
#SBATCH -J anemoi-verify-1h-gnnfgv1
#SBATCH -p u1-h100
#SBATCH -q gpuwf
#SBATCH -N 1
...
#SBATCH --mem=0
#SBATCH -t 8:00:00
#SBATCH -o anemoi-gpu-1mon-1hrleadtime-1hr_refc_value_loss-no_refc_input-gnn-finer_graph_v1-verify.%j.out
#SBATCH -e anemoi-gpu-1mon-1hrleadtime-1hr_refc_value_loss-no_refc_input-gnn-finer_graph_v1-verify.%j.err
