...
#SBATCH --mem=0
#SBATCH -t 24:00:00
#SBATCH -o anemoi-gpu-2gpu-1hr_refc_value-no_refc_input-gnn-train.%j.out
#SBATCH -e anemoi-gpu-2gpu-1hr_refc_value-no_refc_input-gnn-train.%j.err
...
srun --gpu-bind=closest \
  ...
  anemoi-training train \
    ...
    --config-name anemoi-training-rrfs-lam-neural-lam-static-forcing-202405-1h-refc-value-loss-no-refc-input-gnn \
