...
#SBATCH --mem=0
#SBATCH -t 24:00:00
#SBATCH -o anemoi-gpu-2gpu-1hr_refc_value-no_refc_input-finer_graph_v1-single_input-train.%j.out
#SBATCH -e anemoi-gpu-2gpu-1hr_refc_value-no_refc_input-finer_graph_v1-single_input-train.%j.err
...
srun --gpu-bind=closest \
  ...
  anemoi-training train \
    ...
    --config-name anemoi-training-rrfs-lam-neural-lam-static-forcing-202405-1h-refc-value-loss-no-refc-input-finer-graph-v1-single-input \
