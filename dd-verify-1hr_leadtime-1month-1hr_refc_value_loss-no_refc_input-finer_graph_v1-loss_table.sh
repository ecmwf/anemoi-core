...
#SBATCH --mem=0
#SBATCH -t 8:00:00
#SBATCH -o anemoi-gpu-1mon-1hrleadtime_1hr_refc_value_loss-no_refc_input-finer_graph_v1-loss_table.%j.out
#SBATCH -e anemoi-gpu-1mon-1hrleadtime_1hr_refc_value_loss-no_refc_input-finer_graph_v1-loss_table.%j.err
...
training/docs/user-guide/examples/run_rrfs_verify_loss_table_1h_refc_value_no_refc_input_finer_graph_v1.sh \
