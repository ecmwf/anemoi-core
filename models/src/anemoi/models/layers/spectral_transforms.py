    ...
    def __init__(
        ...
        **kwargs,
        ...
        use_graphed_rfft : bool
            ...
            higher memory usage and may not be supported by all devices. If False, rings with equal length use batched PyTorch FFTs with explicit backward.
        """
        super().__init__()
    ...
    def __init__(
        ...
        **kwargs,
        ...
        truncation : int | None
            Truncation parameter for the spherical harmonic transform. Keeping "truncation" wave numbers.
        use_graphed_rfft : bool
            Whether to use a graphed implementation of the rfft on reduced grids, which can be faster but may have higher memory usage and may not be supported by all devices. If False, equal-length rings use batched PyTorch FFTs with explicit backward.
        """
        super().__init__()
        self.nlat = nlat
    ...
    def __init__(
        ...
        **kwargs,
        ...
        use_graphed_irfft : bool
            ...
            higher memory usage and may not be supported by all devices. If False, equal-length rings use batched PyTorch FFTs with explicit backward.
        """
        super().__init__()
