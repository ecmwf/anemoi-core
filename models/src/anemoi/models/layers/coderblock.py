...
class EncoderBlock(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if out_channels_dst != hidden_dim:
            self.proj_nodes_dst = nn.Linear(in_channels_src, hidden_dim, bias=False)
        else:
            self.proj_nodes_dst = nn.Identity()
    ...
    def forward(
        ...
        x_dst_latent = self.proj_nodes_dst(x_dst_latent)
