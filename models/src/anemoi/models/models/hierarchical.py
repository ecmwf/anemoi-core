...
class AnemoiModelEncProcDecHierarchical(AnemoiModelEncProcDec):
    ...
    def _build_networks(self, model_config):
        ...
        self.encoder = instantiate(
            ...
            sub_graph=self._graph_data[(self._graph_name_data, "to", self._graph_name_hidden[0])],
            src_grid_size=self.node_attributes.num_nodes[self._graph_name_data],
            dst_grid_size=self.node_attributes.num_nodes[self._graph_name_hidden[0]],
        )
        ...
        self.processor = instantiate(
            ...
            src_grid_size=self.node_attributes.num_nodes[self._graph_name_hidden[self.num_hidden - 1]],
            dst_grid_size=self.node_attributes.num_nodes[self._graph_name_hidden[self.num_hidden - 1]],
        )
        ...
        self.decoder = instantiate(
            ...
            sub_graph=self._graph_data[(self._graph_name_hidden[0], "to", self._graph_name_data)],
            src_grid_size=self.node_attributes.num_nodes[self._graph_name_hidden[0]],
