...
class AnemoiModelEncProcDecEnsInterpMulti(AnemoiModelEncProcDec):
    ...
    def _calculate_shapes_and_indices(self, data_indices: dict) -> None:
        ...
        self.num_output_channels = len(data_indices.model.output) * self.output_times
    ...
    def _assemble_input(self, x, bse, grid_shard_shapes=None, model_comm_group=None):
    ...
    def _assemble_output(self, x_out, x_skip, batch_size, bse, dtype):
        ...
        x_out = einops.rearrange(x_out, "bs e n (t v) -> bs t e n v", t=self.output_times)
