...
class AnemoiDiffusionModelEncProcDec(BaseGraphModel):
    ...
    def predict_step(
        ...
        pre_processors_tendencies: Optional[Sequence[Optional[nn.Module]]] = None,
        ...
        **kwargs,
        ...
        sampler_params : Optional[dict]
            ...
            These will override the default values from inference_defaults
        pre_processors_tendencies : Optional[Sequence[Optional[nn.Module]]]
            Pre-processing module for tendencies (used by subclasses)
        post_processors_tendencies : Optional[Sequence[Optional[nn.Module]]]
