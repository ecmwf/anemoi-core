...
from anemoi.models.data_indices.index import BaseIndex, DataIndex, ModelIndex
from anemoi.models.data_indices.tensor import BaseTensorIndex, InputTensorIndex, OutputTensorIndex
