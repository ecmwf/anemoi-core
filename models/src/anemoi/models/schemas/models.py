...
from .decoder import InterpolationDecoderSchema  # noqa: TC001
...
from .encoder import InterpolationEncoderSchema  # noqa: TC001
...
class BaseModelSchema(PydanticBaseModel):
    ...
    encoder: Union[
        GNNEncoderSchema, GraphTransformerEncoderSchema, TransformerEncoderSchema, InterpolationEncoderSchema
    ] = Field(
        ...,
        discriminator="target_",
    )
    "GNN encoder schema."
    decoder: Union[
        GNNDecoderSchema, GraphTransformerDecoderSchema, TransformerDecoderSchema, InterpolationDecoderSchema
    ] = Field(
        ...,
        discriminator="target_",
    )
