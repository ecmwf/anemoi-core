...
def print_kernel_table(
    data: list[tuple[str, float]], kernel_counts, kernel_weighted_occupancies, top_n: int = 10, num_iterations=20,
):
...
def analyse_trace(dirpath):
    ...
    print_kernel_table(
        kernel_durations, kernel_counts, kernel_weighted_occupancies, top_n=10, num_iterations=iteration_count,
    )
    console.print("\n")
