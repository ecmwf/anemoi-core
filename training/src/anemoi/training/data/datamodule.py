...
class AnemoiDatasetsDataModule(pl.LightningDataModule):
    ...
    def ds_valid(self) -> MultiDataset:
        ...
        return self._get_dataset(
            ...
            shuffle=self.valid_dataloader_config.shuffle,
    ...
    def ds_test(self) -> MultiDataset:
        ...
        return self._get_dataset(self.test_dataloader_config, shuffle=self.test_dataloader_config.shuffle, label="test")
