...
# reload ckpt :
# RUN_ID=5e62bb9c61a84f74985391a6bd6c4628
...
# CUDA_VISIBLE_DEVICES=0,1,2,3 srun --ntasks=1 \ 
# srun puv run anemoi-training train --config-name=diffusion_incond # hardware.num_gpus_per_node=4  hardware.num_gpus_per_model=2  training.run_id=$RUN_ID 