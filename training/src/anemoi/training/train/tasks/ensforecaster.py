...
class GraphEnsForecaster(BaseGraphModule):
    ...
    def __init__(
        ...
        *,
        ...
        assert self.num_gpus_per_ensemble % self.num_gpus_per_model == 0, (
            "Invalid ensemble vs. model size GPU group configuration: "
            f"{self.num_gpus_per_ensemble} mod {self.num_gpus_per_model} != 0.\
        ...
        self.nens_per_group = self.nens_per_device * self.num_gpus_per_ensemble // self.num_gpus_per_model
