...
class NaNAwareSmoothL1Loss(FunctionalLoss):
    """SmoothL1 loss with density-weighted NaN handling.
    ...
    name: str = "nan_aware_smoothl1"

    def calculate_difference(self, pred: torch.Tensor, target: torch.Tensor) -> torch.Tensor:
        """Calculate the SmoothL1 error.
    ...
    def forward(
        ...
        *,
        ...
        """Calculates the density-weighted SmoothL1 loss.
