...
from anemoi.training.losses.deprecated.graph_scores.edge_base import LegacyBaseGraphEdgeScoreLoss
from anemoi.training.losses.deprecated.graph_scores.graph import LegacyGraphScoreGraph


class LegacyGraphEdgeEnergyScoreLoss(LegacyBaseGraphEdgeScoreLoss):
    ...
    def __init__(
        ...
        """
        graph = LegacyGraphScoreGraph.from_definition(
            loss_graph,
            graph_data,
