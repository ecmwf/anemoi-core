...
PossibleScalars = Annotated[
    str,
    AfterValidator(partial(allowed_values, values=["variable", "loss_weights_mask", "limited_area_mask", "*"])),
]
...
class ImplementedLossesUsingBaseLossSchema(str, Enum):
    ...
    mse_lam = "anemoi.training.losses.limitedarea.WeightedMSELossLimitedArea"
