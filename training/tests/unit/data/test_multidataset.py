...
class TestMultiDataset:
    ...
    @pytest.fixture
    def multi_dataset(self, mocker, dataset_config: dict) -> MultiDataset:
    ...
    def test_timeincrement(self, multi_dataset: MultiDataset):
    ...
    def test_valid_date_indices(self, multi_dataset: MultiDataset):
