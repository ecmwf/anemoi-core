...
def test_cross_dataset_iteration_strategy_requires_batch_size_one() -> None:
    ...
    dataset.strategy = CrossDatasetIterationStrategy.__new__(CrossDatasetIterationStrategy)
