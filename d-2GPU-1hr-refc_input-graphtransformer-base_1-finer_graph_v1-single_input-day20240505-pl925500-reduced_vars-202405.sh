...
#SBATCH --mem=0
#SBATCH -t 24:00:00
#SBATCH -o anemoi-gpu-2gpu-1hr_refc_input-graphtransformer-base_1-finer_graph_v1-single_input-day20240505-pl925500-reduced_vars-train.%j.out
#SBATCH -e anemoi-gpu-2gpu-1hr_refc_input-graphtransformer-base_1-finer_graph_v1-single_input-day20240505-pl925500-reduced_vars-train.%j.err
...
echo "Using base_1 GraphTransformer config with Eagle-style forcing normalization, one-day 20240505, pl925500 reduced-vars, model.num_channels=512"
