...
#SBATCH --mem=0
#SBATCH -t 8:00:00
#SBATCH -o anemoi-gpu-1hrleadtime-1hr_refc_input-graphtransformer-finer_graph_v1-single_input-day20240505-pl925500-reduced_vars-verify.%j.out
#SBATCH -e anemoi-gpu-1hrleadtime-1hr_refc_input-graphtransformer-finer_graph_v1-single_input-day20240505-pl925500-reduced_vars-verify.%j.err
