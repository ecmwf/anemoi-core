...
#SBATCH --mem=0
#SBATCH -t 24:00:00
#SBATCH -o anemoi-gpu-2gpu-1hr_refc_input-transformer-finer_graph_v1-single_input-day20240505-pl925500-reduced_vars-train.%j.out
#SBATCH -e anemoi-gpu-2gpu-1hr_refc_input-transformer-finer_graph_v1-single_input-day20240505-pl925500-reduced_vars-train.%j.err
...
srun --gpu-bind=closest \
  ...
  anemoi-training train \
    ...
    --config-name anemoi-training-rrfs-lam-neural-lam-static-forcing-202405-1h-refc-input-transformer-finer-graph-v1-single-input-day20240505-pl925500-reduced-vars \
