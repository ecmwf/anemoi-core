...
#SBATCH --mem=0
#SBATCH -t 24:00:00
#SBATCH -o anemoi-gpu-2gpu-1hr_refc_value-no_refc_input-diffusion-finer_graph_v1-train.%j.out
#SBATCH -e anemoi-gpu-2gpu-1hr_refc_value-no_refc_input-diffusion-finer_graph_v1-train.%j.err
