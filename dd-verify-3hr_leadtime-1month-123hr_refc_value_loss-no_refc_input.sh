...
#SBATCH --mem=0
#SBATCH -t 8:00:00
#SBATCH -o anemoi-gpu-1mon-3hrleadtime_123hr_refc_value_loss-no_refc_input-verify.%j.out
#SBATCH -e anemoi-gpu-1mon-3hrleadtime-123hr_refc_value_loss-no_refc_input-verify.%j.err
...
training/docs/user-guide/examples/run_rrfs_verify_export_1to3h_refc_value_no_refc_input.sh \
