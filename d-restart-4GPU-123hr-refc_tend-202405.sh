...
#SBATCH --mem=0
#SBATCH -t 24:00:00
#SBATCH -o anemoi-gpu-restart-123hr_refc_tend-train.%j.out
#SBATCH -e anemoi-gpu-restart-123hr_refc_tend-train.%j.err
...
srun --gpu-bind=closest \
  ...
  anemoi-training train \
    ...
    --config-name anemoi-training-rrfs-lam-neural-lam-static-forcing-202405-123h-refc-tendency-loss \
